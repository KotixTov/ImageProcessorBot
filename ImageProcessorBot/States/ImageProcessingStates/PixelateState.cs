...
{
    class PixelateState : ImageProcessingState
    {
        public PixelateState(ChatStateMachine stateMachine, ChatId chatId, ITelegramBotClient botClient, CancellationToken cancellationToken)
