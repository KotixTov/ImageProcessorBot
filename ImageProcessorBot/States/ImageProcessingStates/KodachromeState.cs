...
{
    class KodachromeState : ImageProcessingState
    {
        public KodachromeState(ChatStateMachine stateMachine, ChatId chatId, ITelegramBotClient botClient, CancellationToken cancellationToken)
